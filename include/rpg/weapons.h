...
static const weapon_t WEAPON_STATS[WEAPON_COUNT] = {
    ...
    {WEAPON_TYPE_LASER, FIRE_SINGLE, 200, 8, 0.15, BULLET_PISTOL, 2.5f, 0.15f,
        SFX_WP_LASER_BLASTER, 2}, // BLASTER
    {WEAPON_TYPE_LASER, FIRE_SINGLE, 160, 8, 0.25, BULLET_PISTOL, 2.5f, 0.15f,
        SFX_WP_LASER_REGULATOR, 2}, // REGULATOR
    {WEAPON_TYPE_LASER, FIRE_SINGLE, 150, 12, 0.7, BULLET_PISTOL, 2.5f, 0.15f,
        SFX_WP_LASER_ZAPCANNON, 2}, // PHASER
    {WEAPON_TYPE_LASER, FIRE_SINGLE, 152, 15, 0.8, BULLET_PISTOL, 2.5f, 0.15f,
        SFX_WP_LASER_ZAPCANNON, 2}, // ZAP CANNON
    {WEAPON_TYPE_LASER, FIRE_SINGLE, 140, 11, 0.18, BULLET_PISTOL, 2.5f, 0.15f,
        SFX_WP_LASER_ZAPCANNON, 2}, // RAYGUN
    {WEAPON_TYPE_MELEE, FIRE_SINGLE, 100, 35, 1.1, BULLET_MELEE, 2.5f, 0.15f,
        SFX_WP_MELEE_AXELOTL, 2}, // AXELOTL
    {WEAPON_TYPE_MELEE, FIRE_SINGLE, 100, 25, 0.8, BULLET_KATANA, 2.5f, 0.15f,
        SFX_WP_KATANA, 2}, // KATANA
    {WEAPON_TYPE_MELEE, FIRE_SINGLE, 100, 22, 0.5, BULLET_MELEE, 2.5f, 0.15f,
        SFX_WP_MELEE_BEHEADER, 2}, // BEHEADER
    {WEAPON_TYPE_MELEE, FIRE_SINGLE, 100, 22, 0.8, BULLET_MELEE, 2.5f, 0.15f,
        SFX_WP_KNIFE, 2}, // SCYTHE
    {WEAPON_TYPE_MELEE, FIRE_SINGLE, 200, 10, 0.1, BULLET_MOTORBLADE, 2.5f,
        0.15f, SFX_WP_KNIFE, 2}, // MOTOR BLADE
    {WEAPON_TYPE_PISTOL, FIRE_SINGLE, 9, 9, 0.15, BULLET_PISTOL, 2.5f, 0.15f,
        SFX_WP_BERETTA, 2}, // POND EAGLE
    {WEAPON_TYPE_PISTOL, FIRE_SINGLE, 200, 9, 0.12, BULLET_PISTOL, 2.5f,
        0.15f, SFX_WP_BERETTA, 2}, // TACTIC GUN
    {WEAPON_TYPE_PISTOL, FIRE_SINGLE, 350, 7, 0.15, BULLET_PISTOL, 2.5f, 0.15f,
        SFX_WP_TADPOLES, 2}, // TADPOLES
    {WEAPON_TYPE_PISTOL, FIRE_SINGLE, 160, 10, 0.1, BULLET_PISTOL, 2.5f, 0.15f,
        SFX_WP_RATVOLVER, 2}, // RATVOLVER
    {WEAPON_TYPE_PISTOL, FIRE_SINGLE, 444, 8, 0.15, BULLET_PISTOL, 2.5f, 0.15f,
        SFX_WP_BERETTA, 2}, // WINGERS
    {WEAPON_TYPE_RIFLE, FIRE_SINGLE, 35e5, 24, 0.8, BULLET_AK, 2.5f,
        0.15f, SFX_WP_AK, 2}, // AK
    {WEAPON_TYPE_RIFLE, FIRE_SINGLE, 180, 10, 0.25, BULLET_AK, 2.5f,
    ...
    {WEAPON_TYPE_RIFLE, FIRE_SINGLE, 200, 10, 0.18, BULLET_AK, 2.5f,
        0.15f, SFX_WP_RPK410, 2}, // BIG AK
    {WEAPON_TYPE_SHOTGUN, FIRE_SINGLE, 40, 15, 0.8, BULLET_SHOTGUN, 2.5f,
        0.15f, SFX_WP_SHOTGUN, 2}, // SAWED OFF
    {WEAPON_TYPE_SHOTGUN, FIRE_SINGLE, 6, 15, 0.4, BULLET_SHOTGUN, 2.5f,
        0.15f, SFX_WP_SHOTGUN, 2}, // SCATTERER
    {WEAPON_TYPE_SHOTGUN, FIRE_SINGLE, 50, 16, 0.5, BULLET_SHOTGUN, 2.5f,
        0.15f, SFX_WP_SHOTGUN, 2}, // MOSSTOAD
    {WEAPON_TYPE_SHOTGUN, FIRE_SINGLE, 150, 11, 1, BULLET_SHOTGUN, 2.5f,
        0.15f, SFX_WP_SPAS, 2}, // TURBO SHOTGUN
    {WEAPON_TYPE_SHOTGUN, FIRE_SINGLE, 64, 13, 0.6, BULLET_SHOTGUN, 2.5f,
        0.15f, SFX_WP_DOOM, 2}, // DOOMGUN
    {WEAPON_TYPE_SMG, FIRE_SINGLE, 250, 8, 0.25, BULLET_SMG, 2.5f, 0.15f,
        SFX_WP_UZI, 2}, // UZI
    {WEAPON_TYPE_SMG, FIRE_SINGLE, 200, 7, 0.15, BULLET_SMG, 2.5f, 0.15f,
        SFX_WP_UZI, 2}, // PEW PEWER
    {WEAPON_TYPE_SMG, FIRE_SINGLE, 300, 6, 0.15, BULLET_SMG, 2.5f, 0.15f,
        SFX_WP_MP5, 2}, // VERMINATOR
    {WEAPON_TYPE_SMG, FIRE_SINGLE, 320, 6, 0.22, BULLET_SMG, 2.5f, 0.15f,
        SFX_WP_P90, 2}, // B BANGER
    {WEAPON_TYPE_SMG, FIRE_SINGLE, 400, 6, 0.08, BULLET_SMG, 2.5f, 0.15f,
        SFX_WP_GATLING, 2}, // GATORINGA
    {WEAPON_TYPE_SNIPER, FIRE_SINGLE, 20, 12, 0.5, BULLET_SNIPER, 2.5f, 0.15f,
        SFX_WP_RIFLE, 2}, // HOGGEN
    {WEAPON_TYPE_SNIPER, FIRE_SINGLE, 35, 25, 0.8, BULLET_SNIPER, 2.5f, 0.15f,
        SFX_WP_KALAS, 2}, // KALAS
    {WEAPON_TYPE_SNIPER, FIRE_SINGLE, 50, 26, 0.5, BULLET_SNIPER, 2.5f, 0.15f,
        SFX_WP_RIFLE, 2}, // CRABBER
    {WEAPON_TYPE_SNIPER, FIRE_SINGLE, 40, 35, 1, BULLET_SNIPER, 2.5f, 0.15f,
        SFX_WP_RIFLE, 2}, // SUC 2
    {WEAPON_TYPE_SNIPER, FIRE_SINGLE, 30, 55, 0.85, BULLET_SNIPER, 2.5f, 0.15f,
        SFX_WP_RIFLE, 2}, // BAS
    {WEAPON_TYPE_RIFLE, FIRE_SINGLE, 30, 12, 0.28, BULLET_AK, 2.5f, 0.15f,
        SFX_WP_TOYRIFLE, 3}, // RIFLE_NERF
    {WEAPON_TYPE_RIFLE, FIRE_SINGLE, 200, 10, 0.3, BULLET_SMG, 2.5f, 0.15f,
        SFX_WP_AK, 3}, // SMG_BADGER
    {WEAPON_TYPE_RIFLE, FIRE_SINGLE, 100, 30, 1.3, BULLET_MELEE, 2.5f, 0.15f,
        SFX_WP_CLEVEAGE, 3}, // MELEE_CLEAVER
    {WEAPON_TYPE_RIFLE, FIRE_SINGLE, 250, 10, 0.22, BULLET_AK, 2.5f, 0.15f,
        SFX_WP_TENTACLE, 3}, // BOSS_CTHULU
    {WEAPON_TYPE_RIFLE, FIRE_SINGLE, 30, 18, 0.5, BULLET_PISTOL, 2.5f, 0.15f,
        SFX_WP_BERETTA, 3}, // PISTOL_RAYGUN
    {WEAPON_TYPE_PISTOL, FIRE_SINGLE, 200, 9, 0.18, BULLET_PISTOL, 2.5f, 0.15f,
        SFX_WP_RETROVOLVER, 3}, // PISTOL_REVOLVER
    {WEAPON_TYPE_PISTOL, FIRE_SINGLE, 150, 11, 0.35, BULLET_PISTOL, 2.5f,
    0.15f, SFX_WP_BERETTA, 3}, // PISTOL_FLAREGUN
    {WEAPON_TYPE_RIFLE, FIRE_SINGLE, 200, 7, 0.9, BULLET_ARROW, 2.5f, 0.15f,
        SFX_WP_XBOW, 3}, // SNIPER_CROSSBOW
    {WEAPON_TYPE_PISTOL, FIRE_SINGLE, 200, 9, 0.25, BULLET_PISTOL, 2.5f,
        0.15f, SFX_WP_BERETTA, 3}, // PISTOL_ASSASSIN
    {WEAPON_TYPE_PISTOL, FIRE_SINGLE, 240, 9, 0.1, BULLET_PISTOL, 2.5f, 0.15f,
        SFX_WP_FINGERPISTOL, 3}, // PISTOL_HAND
    {WEAPON_TYPE_PISTOL, FIRE_SINGLE, 210, 12, 0.15, BULLET_PISTOL, 2.5f,
        0.15f, SFX_WP_BERETTA, 3}, // PISTOL_STARLORD
    {WEAPON_TYPE_RIFLE, FIRE_SINGLE, 400, 9, 0.1, BULLET_AK, 2.5f, 0.15f,
        SFX_WP_NAILGUN, 3}, // SMG_NAILGUN
    {WEAPON_TYPE_SHOTGUN, FIRE_SINGLE, 40, 25, 0.7, BULLET_SHOTGUN, 2.5f,
        0.15f, SFX_WP_SLUGSHOTGUN, 3}, // SHOTGUN_PLANT
    {WEAPON_TYPE_SNIPER, FIRE_SINGLE, 100, 9, 0.4, BULLET_SNIPER, 2.5f, 0.15f,
        SFX_WP_RIFLE, 3}, // SNIPER_DRAGUNOV
    {WEAPON_TYPE_PISTOL, FIRE_SINGLE, 120, 5, 0.25, BULLET_PISTOL, 2.5f, 0.15f,
        SFX_WP_BOLTER, 3}, // PISTOL_GRAPLING
    {WEAPON_TYPE_RIFLE, FIRE_SINGLE, 100, 18, 0.55, BULLET_AK, 2.5f, 0.15f,
        SFX_WP_TWINKLESTAR, 3}, // RIFLE_PARINO
    {WEAPON_TYPE_SNIPER, FIRE_SINGLE, 40, 40, 1.4, BULLET_SNIPER, 2.5f, 0.15f,
        SFX_WP_ELEPHANTGUN, 3}, // SNIPER_ARTIC
    {WEAPON_TYPE_MELEE, FIRE_SINGLE, 100, 20, 0.3, BULLET_MELEE, 2.5f, 0.15f,
        SFX_WP_KNUCKLES, 3}, // MELEE_IRONFIST
    {WEAPON_TYPE_MELEE, FIRE_SINGLE, 100, 15, 0.5, BULLET_MELEE, 2.5f, 0.15f,
        SFX_WP_BOOMERANG, 3}, // MELEE_BOOMERANG
    {WEAPON_TYPE_MELEE, FIRE_SINGLE, 100, 30, 1.1, BULLET_MELEE, 2.5f, 0.15f,
        SFX_WP_CARNAGEGEAR, 3}, // MELEE_SAURON
    {WEAPON_TYPE_MELEE, FIRE_SINGLE, 100, 20, 0.65, BULLET_MELEE, 2.5f, 0.15f,
        SFX_WP_SWHOOSER, 3}, // MELEE_LIGHTSABER
    {WEAPON_TYPE_RIFLE, FIRE_SINGLE, 35, 40, 0.5, BULLET_AK, 2.5f, 0.15f,
    ...
    {WEAPON_TYPE_MELEE, FIRE_SINGLE, 35, 60, 0.5, BULLET_MELEE, 2.5f, 0.15f,
        SFX_WP_FLAMINGBALLS, 3}, // MELEE_RACKET
    {WEAPON_TYPE_SHOTGUN, FIRE_SINGLE, 200, 10, 0.6, BULLET_SHOTGUN, 2.5f,
        0.15f, SFX_WP_SLUGSHOTGUN, 3}, // SHOTGUN_BOLTACTION
    {WEAPON_TYPE_SHOTGUN, FIRE_SINGLE, 190, 10, 0.45, BULLET_SHOTGUN, 2.5f,
        0.15f, SFX_WP_AK, 3}, // SHOTGUN_SKULL
    {WEAPON_TYPE_MELEE, FIRE_SINGLE, 300, 9, 0.2, BULLET_MELEE, 2.5f, 0.15f,
        SFX_WP_KNIFE, 3}, // MELEE_GUITAR
    {WEAPON_TYPE_RIFLE, FIRE_SINGLE, 90, 30, 0.75, BULLET_AK, 2.5f, 0.15f,
        SFX_WP_SNAKEEYES, 3}, // BOSS_SNAKE
    {WEAPON_TYPE_MELEE, FIRE_SINGLE, 150, 10, 0.25, BULLET_MELEE, 2.5f, 0.15f,
        SFX_WP_KNIFE, 3}, // MELEE_BAMBO
    {WEAPON_TYPE_SNIPER, FIRE_SINGLE, 90, 25, 1.2, BULLET_SNIPER, 2.5f, 0.15f,
        SFX_WP_CROSSBOW_2, 3}, // SNIPER_BONE_CROSSBOW
    {WEAPON_TYPE_MELEE, FIRE_SINGLE, 100, 15, 0.65, BULLET_MELEE, 2.5f, 0.15f,
        SFX_WP_FISHINGROD, 3} // MELEE_FISHING_ROD
};
