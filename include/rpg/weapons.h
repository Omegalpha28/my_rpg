...
static const weapon_t WEAPON_STATS[WEAPON_COUNT] = {
    {WEAPON_TYPE_EXPLOSIVE, FIRE_SINGLE, 1, 10, 0.5, BULLET_ROCKET, 7.5f,
    ...
    {WEAPON_TYPE_LASER, FIRE_SINGLE, 20, 10, 0.5, BULLET_PISTOL, 2.5f, 0.15f,
    ...
    {WEAPON_TYPE_MELEE, FIRE_SINGLE, 0, 10, 0.5, BULLET_MELEE, 2.5f, 0.15f,
        SFX_WP_MELEE_AXELOTL, 2}, // AXELOTL
    {WEAPON_TYPE_MELEE, FIRE_SINGLE, 0, 10, 0.5, BULLET_KATANA, 2.5f, 0.15f,
        SFX_WP_KATANA, 2}, // KATANA
    {WEAPON_TYPE_MELEE, FIRE_SINGLE, 0, 10, 0.5, BULLET_MELEE, 2.5f, 0.15f,
        SFX_WP_MELEE_BEHEADER, 2}, // BEHEADER
    {WEAPON_TYPE_MELEE, FIRE_SINGLE, 0, 10, 0.5, BULLET_MELEE, 2.5f, 0.15f,
        SFX_WP_KNIFE, 2}, // SCYTHE
    {WEAPON_TYPE_MELEE, FIRE_SINGLE, 0, 10, 0.5, BULLET_MOTORBLADE, 2.5f,
        0.15f, SFX_WP_KNIFE, 2}, // MOTOR BLADE
    {WEAPON_TYPE_PISTOL, FIRE_SINGLE, 20, 10, 0.5, BULLET_PISTOL, 2.5f, 0.15f,
        SFX_WP_BERETTA, 2}, // POND EAGLE
    {WEAPON_TYPE_PISTOL, FIRE_SINGLE, 20, 10, 0.5, BULLET_PISTOL, 2.5f, 0.15f,
        SFX_WP_BERETTA, 2}, // TACTIC GUN
    {WEAPON_TYPE_PISTOL, FIRE_SINGLE, 20, 10, 0.5, BULLET_PISTOL, 2.5f, 0.15f,
    ...
    {WEAPON_TYPE_RIFLE, FIRE_SINGLE, 20, 10, 0.5, BULLET_AK, 2.5f,
    ...
    {WEAPON_TYPE_SHOTGUN, FIRE_SINGLE, 20, 10, 0.5, BULLET_SHOTGUN, 2.5f,
    ...
    {WEAPON_TYPE_SMG, FIRE_SINGLE, 20, 10, 0.5, BULLET_SMG, 2.5f, 0.15f,
        SFX_WP_UZI, 2}, // UZI
    {WEAPON_TYPE_SMG, FIRE_SINGLE, 20, 10, 0.5, BULLET_SMG, 2.5f, 0.15f,
    ...
    {WEAPON_TYPE_SMG, FIRE_SINGLE, 200, 1, 0.05, BULLET_SMG, 2.5f, 0.15f,
        SFX_WP_GATLING, 2}, // GOTORINGA
    ...
    {WEAPON_TYPE_SNIPER, FIRE_SINGLE, 20, 10, 0.5, BULLET_SNIPER, 2.5f, 0.15f,
        SFX_WP_RIFLE, 2}, // BAS
    {WEAPON_TYPE_RIFLE, FIRE_SINGLE, 30, 10, 0.5, BULLET_AK, 2.5f, 0.15f,
        SFX_WP_AK, 3}, // RIFLE_NERF
    {WEAPON_TYPE_RIFLE, FIRE_SINGLE, 30, 10, 0.5, BULLET_SMG, 2.5f, 0.15f,
        SFX_WP_AK, 3}, // SMG_BADGER
    {WEAPON_TYPE_RIFLE, FIRE_SINGLE, 30, 10, 0.5, BULLET_MELEE, 2.5f, 0.15f,
        SFX_WP_AK, 3}, // MELEE_CLEAVER
    {WEAPON_TYPE_RIFLE, FIRE_SINGLE, 30, 10, 0.5, BULLET_AK, 2.5f, 0.15f,
        SFX_WP_AK, 3}, // BOSS_CTHULU
    {WEAPON_TYPE_RIFLE, FIRE_SINGLE, 30, 1e5, 0.5, BULLET_PISTOL, 2.5f, 0.15f,
        SFX_WP_BERETTA, 3}, // PISTOL_RAYGUN
    {WEAPON_TYPE_PISTOL, FIRE_SINGLE, 30, 10, 0.5, BULLET_PISTOL, 2.5f, 0.15f,
        SFX_WP_BERETTA, 3}, // PISTOL_REVOLVER
    {WEAPON_TYPE_PISTOL, FIRE_SINGLE, 30, 10, 0.5, BULLET_PISTOL, 2.5f, 0.15f,
        SFX_WP_BERETTA, 3}, // PISTOL_FLAREGUN
    {WEAPON_TYPE_RIFLE, FIRE_SINGLE, 30, 10, 0.5, BULLET_ARROW, 2.5f, 0.15f,
        SFX_WP_AK, 3}, // SNIPER_CROSSBOW
    {WEAPON_TYPE_PISTOL, FIRE_SINGLE, 30, 10, 0.5, BULLET_PISTOL, 2.5f, 0.15f,
        SFX_WP_BERETTA, 3}, // PISTOL_ASSASSIN
    {WEAPON_TYPE_PISTOL, FIRE_SINGLE, 30, 10, 0.5, BULLET_PISTOL, 2.5f, 0.15f,
    ...
    {WEAPON_TYPE_SHOTGUN, FIRE_SINGLE, 30, 10, 0.5, BULLET_SHOTGUN, 2.5f,
        0.15f, SFX_WP_AK, 3}, // SHOTGUN_PLANT
    {WEAPON_TYPE_SNIPER, FIRE_SINGLE, 30, 10, 0.5, BULLET_SNIPER, 2.5f, 0.15f,
    ...
    {WEAPON_TYPE_MELEE, FIRE_SINGLE, 30, 10, 0.5, BULLET_MELEE, 2.5f, 0.15f,
