...
static const weapon_t WEAPON_STATS[WEAPON_COUNT] = {
    ...
    {WEAPON_TYPE_SNIPER, FIRE_SINGLE, 20, 10, 20, BULLET_SNIPER, 2.5f, 0.15f,
        SFX_WP_RIFLE, 3}, // BAS
    {WEAPON_TYPE_RIFLE, FIRE_SINGLE, 30, 10, 20, BULLET_AK, 2.5f, 0.15f,
        SFX_WP_AK, 3}, // RIFLE_NERF
    {WEAPON_TYPE_RIFLE, FIRE_SINGLE, 30, 10, 20, BULLET_SMG, 2.5f, 0.15f,
        SFX_WP_AK, 3}, // SMG_BADGER
    {WEAPON_TYPE_RIFLE, FIRE_SINGLE, 30, 10, 20, BULLET_MELEE, 2.5f, 0.15f,
        SFX_WP_AK, 3}, // MELEE_CLEAVER
    {WEAPON_TYPE_RIFLE, FIRE_SINGLE, 30, 10, 20, BULLET_AK, 2.5f, 0.15f,
        SFX_WP_AK, 3}, // BOSS_CTHULU
    {WEAPON_TYPE_RIFLE, FIRE_SINGLE, 30, 10, 20, BULLET_PISTOL, 2.5f, 0.15f,
        SFX_WP_BERETTA, 3}, // PISTOL_RAYGUN
    {WEAPON_TYPE_PISTOL, FIRE_SINGLE, 30, 10, 20, BULLET_PISTOL, 2.5f, 0.15f,
        SFX_WP_BERETTA, 3}, // PISTOL_REVOLVER
    {WEAPON_TYPE_PISTOL, FIRE_SINGLE, 30, 10, 20, BULLET_PISTOL, 2.5f, 0.15f,
        SFX_WP_BERETTA, 3}, // PISTOL_FLAREGUN
    {WEAPON_TYPE_RIFLE, FIRE_SINGLE, 30, 10, 20, BULLET_ARROW, 2.5f, 0.15f,
    ...
    {WEAPON_TYPE_SHOTGUN, FIRE_SINGLE, 30, 10, 20, BULLET_SHOTGUN, 2.5f, 0.15f,
        SFX_WP_AK, 3}, // SHOTGUN_PLANT
    {WEAPON_TYPE_SNIPER, FIRE_SINGLE, 30, 10, 20, BULLET_SNIPER, 2.5f, 0.15f,
    ...
    {WEAPON_TYPE_MELEE, FIRE_SINGLE, 30, 10, 20, BULLET_MELEE, 2.5f, 0.15f,
    ...
    {WEAPON_TYPE_SHOTGUN, FIRE_SINGLE, 30, 10, 20, BULLET_SHOTGUN, 2.5f, 0.15f,
        SFX_WP_AK, 3}, // SHOTGUN_BOLTACTION
    {WEAPON_TYPE_SHOTGUN, FIRE_SINGLE, 30, 10, 20, BULLET_SHOTGUN, 2.5f, 0.15f,
        SFX_WP_AK, 3}, // SHOTGUN_SKULL
    {WEAPON_TYPE_MELEE, FIRE_SINGLE, 30, 10, 20, BULLET_MELEE, 2.5f, 0.15f,
